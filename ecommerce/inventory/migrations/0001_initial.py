...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='format: required, unique, max-255', max_length=155, unique=True, verbose_name='product attribute name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('store_price', models.DecimalField(decimal_places=2, error_messages={'name': {'max_length': 'the price must be between 0 and 999.99.'}}, help_text='format: maximum price 999.99', max_digits=5, verbose_name='store price')),
                ...
                ('attribute_values', models.ManyToManyField(related_name='product_attribute_value', through='inventory.ProductAttributeValues', to='inventory.ProductAttributeValue')),
